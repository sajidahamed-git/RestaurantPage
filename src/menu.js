...
menu.classList.add('highlightbtn')
  ...
  p1.textContent =
    "Signature Dish: A blend of stellar spices and fresh ingredients.";
  ...
  p3.textContent =
    "A warm, hearty bowl filled with the flavors of the universe";
